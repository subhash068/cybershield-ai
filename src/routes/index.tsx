  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        >
          <div className="h-[360px] p-2">
            <WorldMap events={attacks} max={70} />
          </div>
        </Panel>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <Panel
          className="xl:col-span-2"
          title="Attack Volume — 24h"
          subtitle="Attacks vs. blocked vs. anomalies"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <Panel
          className="xl:col-span-2"
          title="Live Threat Timeline"
          subtitle="Streaming events · last 60s"
          action={
            <span className="text-[10px] text-[color:var(--neon-red)] animate-blink tracking-widest">
              ● STREAM
            </span>
          }
        >
        ...
        <Panel title="Top Attacking Countries">
          ...
          <div className="mt-4 pt-3 border-t border-border flex items-center gap-2 text-xs text-muted-foreground">
            ...
            AI flagged <span className="text-foreground font-semibold mx-1">3</span> regions as
            elevated risk
          </div>
        </Panel>
      </div>
