  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title="Adversary & IOC Intelligence"
        description="Correlated threat actors, indicators of compromise, attack categories and AI-generated context."
      />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <Panel
          ...
          subtitle="Correlated across endpoints, network, identity"
        >
                    ...
                    <td className="py-2 px-2">
                      <div className="flex items-center gap-2">
                        <div className="w-20 h-1.5 rounded-full bg-secondary overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-[color:var(--neon-blue)] to-[color:var(--neon-cyan)]"
